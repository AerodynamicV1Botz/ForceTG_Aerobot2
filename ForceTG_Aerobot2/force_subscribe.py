...
from ForceTG_Aerobot2.database.chats_sql import get_force_chat, change_force_chat, get_only_owner
...
async def fsub(bot, msg: Message):
    ...
    if len(msg.command) == 1:
        ...
        if bot_chat_member.status ==ChatMemberStatus.ADMINISTRATOR:
            ...
            await msg.reply("Successful. Now I'll Invite people who haven't joined that chat. \n\nUse /settings to change settings.")
        else:
